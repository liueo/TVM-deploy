...
from gluoncv.utils.export_helper import _DefaultPreprocess
...
ctx = tvm.gpu(0)
detector = get_model('ResNet50_v2', pretrained=True)
export_tvm('ResNet50_v2', detector, (3,224,224), ctx=mx.cpu(), preprocess=MyPreprocess(), target='llvm', use_autotvm=False)
