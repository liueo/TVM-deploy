...
def main():
    cmd_b = "cd .. ; mkdir build ; cd build ; cmake .. ; make "
    os.system(cmd_b)
    os.system("cp ../build/gcv_lite_classify .")
    os.system("cp ../build/gcv_lite_detection .")
    ...
    for model_name in model_list_c:
        ...
        os.system(cmd_m)
        cmd_p = "zip {}.zip gcv_lite_classify model_0000.params model_graph.json model_lib.so imagenet_classes.txt".format(model_name)
        os.system(cmd_p)
    ...
    for model_name in model_list_d:
        ...
        os.system(cmd_m)
        cmd_p = "zip {}.zip gcv_lite_detection model_0000.params model_graph.json model_lib.so".format(model_name)
        os.system(cmd_p)
